    ...
    materials: {
      Quadro: THREE.MeshStandardMaterial,Pneu: THREE.MeshStandardMaterial,Eixo: THREE.MeshStandardMaterial,Roda: THREE.MeshStandardMaterial,Faixa: THREE.MeshStandardMaterial,PedalInterno: THREE.MeshStandardMaterial,PedalExterno: THREE.MeshStandardMaterial,Raio: THREE.MeshStandardMaterial
        ...
        export default function Model(props: JSX.IntrinsicElements['group']) {
          ...
          const { nodes, materials } = useGLTF('https://vazxmixjsiawhamofees.supabase.co/storage/v1/object/public/models/bike/model.gltf') as GLTFResult
          return (
...
useGLTF.preload('https://vazxmixjsiawhamofees.supabase.co/storage/v1/object/public/models/bike/model.gltf')